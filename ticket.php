...
$stmt = $conn->prepare("
    SELECT o.idOrden, o.fecha, od.cantidad, od.precio_unitario, a.Descripcion, c.Nombre AS cliente
    FROM Ordenes o
    JOIN OrdenDetalle od ON o.idOrden = od.idOrden
...
<div class="container">
  ...
  <?php if (empty($ticket)): ?>
    <div class="mensaje">No se encontraron productos para esta orden.</div>
  <?php else: ?>
